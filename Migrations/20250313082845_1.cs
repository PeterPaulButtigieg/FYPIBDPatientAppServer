        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthcareProfessionalId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_HealthcareProfessionalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Concents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Concents_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Diagnoses_AspNetUsers_HealthcareProfessionalId",
                        column: x => x.HealthcareProfessionalId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DietaryLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DietaryLogs_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HydrationLogs_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LabOrders_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SleepDuration = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Exercise = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LifestyleLogs_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SymptomLogs_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientMedications_AspNetUsers_HealthcareProfessionalId",
                        column: x => x.HealthcareProfessionalId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Concents_UserId",
                table: "Concents",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Diagnoses_HealthcareProfessionalId",
                table: "Diagnoses",
                column: "HealthcareProfessionalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DietaryLogs_PatientId",
                table: "DietaryLogs",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_HydrationLogs_PatientId",
                table: "HydrationLogs",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_LabOrders_ApplicationUserId",
                table: "LabOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LifestyleLogs_PatientId",
                table: "LifestyleLogs",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientMedications_HealthcareProfessionalId",
